...
import SancutuaryLogo from "../../assets/images/logo/sanctuary.webp";
      ...
      <div className="mx-auto max-w-5xl px-4 py-16 sm:px-6 lg:px-8">
        ...
        <div className="mt-4 flex flex-col items-center">
          <h3 className="font-clash text-xl font-semibold text-white">
            We are listed supporting group at:
          </h3>
          <a
            href="https://cityofsanctuary.org/"
            rel="noopener noreferrer"
            target="_blank"
          >
            <img width={120} src={SancutuaryLogo} alt="Sanctuary Logo" />
          </a>
        </div>
